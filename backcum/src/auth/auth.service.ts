...
export class AuthService {
  ...
  async login(email: string, password: string): Promise<{ message: string; name?: string; id?: string }> {
    ...
    return { message: 'Inicio de sesión exitoso', name: data.name, id: data.id };
  }
